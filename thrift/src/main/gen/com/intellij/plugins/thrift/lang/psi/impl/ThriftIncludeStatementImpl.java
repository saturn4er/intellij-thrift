...
public class ThriftIncludeStatementImpl extends ThriftPsiCompositeElementImpl implements ThriftIncludeStatement {

  public ThriftIncludeStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
