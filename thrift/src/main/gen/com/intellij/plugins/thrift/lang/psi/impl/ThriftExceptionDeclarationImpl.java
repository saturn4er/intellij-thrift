...
public class ThriftExceptionDeclarationImpl extends ThriftTopLevelDeclarationImpl implements ThriftExceptionDeclaration {

  public ThriftExceptionDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
