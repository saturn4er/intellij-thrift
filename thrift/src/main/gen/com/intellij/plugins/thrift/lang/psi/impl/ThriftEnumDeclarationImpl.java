...
public class ThriftEnumDeclarationImpl extends ThriftTopLevelDeclarationImpl implements ThriftEnumDeclaration {

  public ThriftEnumDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
