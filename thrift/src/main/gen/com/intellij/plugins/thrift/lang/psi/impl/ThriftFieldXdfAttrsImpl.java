...
public class ThriftFieldXdfAttrsImpl extends ThriftPsiCompositeElementImpl implements ThriftFieldXdfAttrs {

  public ThriftFieldXdfAttrsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ThriftVisitor visitor) {
    visitor.visitFieldXdfAttrs(this);
  }
