...
public class ThriftUnionDeclarationImpl extends ThriftTopLevelDeclarationImpl implements ThriftUnionDeclaration {

  public ThriftUnionDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
