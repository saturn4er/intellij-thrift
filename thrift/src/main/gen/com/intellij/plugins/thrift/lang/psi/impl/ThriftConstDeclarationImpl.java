...
public class ThriftConstDeclarationImpl extends ThriftTopLevelDeclarationImpl implements ThriftConstDeclaration {

  public ThriftConstDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public ThriftAnnotatedType getAnnotatedType() {
    return findChildByClass(ThriftAnnotatedType.class);
  }
