...
public class ThriftTypeDeclarationImpl extends ThriftTopLevelDeclarationImpl implements ThriftTypeDeclaration {

  public ThriftTypeDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
