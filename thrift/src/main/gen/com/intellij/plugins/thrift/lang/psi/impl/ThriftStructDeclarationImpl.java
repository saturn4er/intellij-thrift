...
public class ThriftStructDeclarationImpl extends ThriftTopLevelDeclarationImpl implements ThriftStructDeclaration {

  public ThriftStructDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
