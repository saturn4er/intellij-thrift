...
public class ThriftServiceDeclarationImpl extends ThriftTopLevelDeclarationImpl implements ThriftServiceDeclaration {

  public ThriftServiceDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ThriftVisitor visitor) {
    visitor.visitServiceDeclaration(this);
  }
