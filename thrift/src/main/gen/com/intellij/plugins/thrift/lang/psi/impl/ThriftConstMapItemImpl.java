...
public class ThriftConstMapItemImpl extends ThriftPsiCompositeElementImpl implements ThriftConstMapItem {

  public ThriftConstMapItemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ThriftVisitor visitor) {
    visitor.visitConstMapItem(this);
  }
