...
public class ThriftFunctionThrowsImpl extends ThriftPsiCompositeElementImpl implements ThriftFunctionThrows {

  public ThriftFunctionThrowsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ThriftVisitor visitor) {
    visitor.visitFunctionThrows(this);
  }
