...
public class ThriftSenumDeclarationImpl extends ThriftTopLevelDeclarationImpl implements ThriftSenumDeclaration {

  public ThriftSenumDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ThriftVisitor visitor) {
    visitor.visitSenumDeclaration(this);
  }
