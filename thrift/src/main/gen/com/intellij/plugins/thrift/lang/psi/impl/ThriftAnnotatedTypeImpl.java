...
public class ThriftAnnotatedTypeImpl extends ThriftPsiCompositeElementImpl implements ThriftAnnotatedType {

  public ThriftAnnotatedTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
